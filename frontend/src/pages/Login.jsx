    ...
    <div className="min-h-screen flex items-center justify-center overflow-hidden relative"
      ...
      <div className="absolute pointer-events-none"
        style={{
          ...
          borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(110,198,230,0.04) 0%, transparent 60%)',
        }}
      />
        ...
        >
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-lg text-sm font-semibold transition-all duration-300 mt-2 relative overflow-hidden"
              style={{
